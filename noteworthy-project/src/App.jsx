...
function Members() {
  ...
  {
    name: 'Alex Pease',
    pronouns: 'Please do not thanks',
    voicePart: 'Bass',
    majorMinor: 'Chemistry Major, Data Science + Music minors',
    semesterInBerkeley: '4th',
    semesterInNoteworthy: '3rd',
    interests: 'Singing, gaming, complaining, no longer cyberbullying the managers on discord since they started posting in announcements!',
  ...
  },
  {
    ...
    semesterInBerkeley: 'No one knows',
    semesterInNoteworthy: '3rd',
    interests: 'Dropping out of school to try and make it on Broadway',
    bio: `A few years ago, I was driving alone on the highway at cruising speed...`
  },
  {
    name: 'Ellington Chen',
    pronouns: 'He/Him',
    voicePart: 'Baritone',
    majorMinor: 'In order from favorite to least favorite I\'d probably go C,G,E♭, B, F#, D♭, A♭,A,A#...',
    semesterInBerkeley: '4th',
  ...
  },
  {
    ...
    pronouns: 'He/Him',
    voicePart: 'Baritone',
    majorMinor: 'Computer sceince',
    semesterInBerkeley: '8th',
    semesterInNoteworthy: '2nd',
  ...
  },
  {
    ...
    bio: 'The same one from before is good thankssssssssssssssssssssss'}, 
    {
      name: 'Athena Liu',
      pronouns: 'They/He',
      voicePart: 'Tenor 1',
    ...
    },
    {
      ...
      pronouns: 'He/Him/His',
      voicePart: 'Bass',
      majorMinor: 'Undeclared (Intended Applied Math)',
      semesterInBerkeley: '2nd',
      semesterInNoteworthy: '1st',
      ...
      <div className="members-section">
        ...
        <div className="members-grid">
          ...
          <div key={index} className="member-card" onClick={() => setSelectedMemberIndex(index)}>
            ...
            <p><b>Voice: </b>{member.voicePart}</p>
          </div>
          ))}
        </div>
      ...
      <div className="modal-backdrop" onClick={onClose}>
        <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-text-content">
            <h2>{member.name}</h2>
            <p><b>Pronouns: </b>{member.pronouns}</p>
            <p> <b> Major/ Minor: </b>{member.majorMinor}</p>
            <p><b>Semester in Berkeley: </b>{member.semesterInBerkeley}</p>
            <p><b>Semester in Noteworthy: </b>{member.semesterInNoteworthy}</p>
            <p><b>Interests: </b>{member.interests}</p>
